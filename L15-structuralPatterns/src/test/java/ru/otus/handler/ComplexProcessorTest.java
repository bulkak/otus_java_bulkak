...
import ru.otus.processor.ProcessorThrowInEvenSecond;
...
class ComplexProcessorTest {
    ...
    void evenSecondExceptionTest() {
        ...
        var complexProcessor = new ComplexProcessor(processors, (Exception ex) -> {
            throw new ComplexProcessorTest.TestException(ex.getMessage());
        });

        //when
        Exception exception = assertThrows(RuntimeException.class, () -> complexProcessor.handle(message));
        String expectedMessage = "What's the hell?!";
