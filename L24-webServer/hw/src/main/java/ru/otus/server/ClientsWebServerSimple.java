...
import ru.otus.servlet.ClientFormServlet;
...
public class ClientsWebServerSimple implements ClientsWebServer {
    ...
    private ServletContextHandler createServletContextHandler() {
        ...
        servletContextHandler.addServlet(new ServletHolder(new ClientFormServlet(templateProcessor, serviceClient)), "/client");
        return servletContextHandler;
    }
}
