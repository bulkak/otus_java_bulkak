...
public class DbServiceClientImpl implements DBServiceClient {
    ...
    private MyCache<Long, Optional<Client>> cache = null;
    ...
    public DbServiceClientImpl(TransactionRunner transactionRunner, DataTemplate<Client> clientDataTemplate, MyCache<Long, Optional<Client>> cache) {
        this.transactionRunner = transactionRunner;
        this.clientDataTemplate = clientDataTemplate;
        this.cache = cache;
    }
    ...
    private void putToCache(Long id, Client client) {
        if (cache != null) {
            cache.put(id, Optional.of(client));
        }
    }
